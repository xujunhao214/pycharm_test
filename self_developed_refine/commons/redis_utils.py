# self_developed_refine/commons/redis_utils.py
import redis
import json
from typing import Dict, Any, List
from self_developed_refine.config import ENV_CONFIG  # 导入配置数据
from self_developed_refine.commons.enums import Environment  # 导入现有枚举
