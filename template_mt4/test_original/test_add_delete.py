...
import requests
import os
from template_mt4.VAR.VAR import *  # 若URL_TOP等变量在VAR.py，需保留
...
def get_follow_accounts_from_runtime_json():
    """
    从 template_mt4/VAR/runtime_vars_cloud.json 中提取多账号数据
    ...
    # 若当前脚本路径与VAR目录层级不同，可直接写绝对路径（如"D:/pycharm_test/template_mt4/VAR/runtime_vars_cloud.json"）
