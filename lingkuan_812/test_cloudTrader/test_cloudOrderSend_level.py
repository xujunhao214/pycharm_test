# lingkuan_812/tests/test_云策略_ordersend.py
import allure
import logging
import pytest
import time
...
from lingkuan_812.conftest import var_manager
from lingkuan_812.commons.api_base import APITestBase  # 导入基础类
from lingkuan_812.commons.redis_utils import *
...
class TestcloudTrader_level(APITestBase):
    ...
    # ---------------------------
    # 云策略-云策略列表-云策略跟单账号自己平仓
    # ---------------------------
    @allure.title("云策略-云策略列表-云策略跟单账号自己平仓")
