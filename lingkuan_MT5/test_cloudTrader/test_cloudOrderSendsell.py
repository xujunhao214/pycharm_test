...
@allure.feature("云策略复制下单-开仓的场景校验-sell")
class TestCloudStrategyOrdersell:
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                        ...
                        WHERE foi.operation_type = %s
                            ...
                            AND fod.comment = %s
                    """
                params = ('0', MT5cloudTrader_user_accounts_2, "changjing1")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                        ...
                        WHERE foi.operation_type = %s
                            ...
                            AND fod.comment = %s
                            """
                params = ('0', MT5cloudTrader_user_accounts_4, "changjing1")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                        ...
                        WHERE foi.operation_type = %s
                            ...
                            AND fod.comment = %s
                    """
                params = ('1', MT5cloudTrader_user_accounts_2, MT5cloudTrader_MT5vps_ids_1, "changjing1")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                               ...
                               WHERE foi.operation_type = %s
                                   ...
                                   AND fod.comment = %s
                           """
                params = ('1', MT5cloudTrader_user_accounts_4, MT5cloudTrader_MT5vps_ids_3, "changjing1")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('0', MT5cloudTrader_user_accounts_2, "changjing2")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                        ...
                        WHERE foi.operation_type = %s
                            ...
                            AND fod.comment = %s
                            """
                params = ('0', MT5cloudTrader_user_accounts_4, "changjing2")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('1', MT5cloudTrader_user_accounts_2, MT5cloudTrader_MT5vps_ids_1, "changjing2")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                           ...
                           WHERE foi.operation_type = %s
                               ...
                               AND fod.comment = %s
                                   """
                params = ('1', MT5cloudTrader_user_accounts_4, MT5cloudTrader_MT5vps_ids_3, "changjing2")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('0', MT5cloudTrader_user_accounts_2, "changjing3")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                            ...
                            WHERE foi.operation_type = %s
                                ...
                                AND fod.comment = %s
                        """
                params = ('0', MT5cloudTrader_user_accounts_4, "changjing3")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('1', MT5cloudTrader_user_accounts_2, MT5cloudTrader_MT5vps_ids_1, "changjing3")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                            ...
                            WHERE foi.operation_type = %s
                                ...
                                AND fod.comment = %s
                        """
                params = ('1', MT5cloudTrader_user_accounts_4, MT5cloudTrader_MT5vps_ids_3, "changjing3")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('0', MT5cloudTrader_user_accounts_2, "changjing4")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                           ...
                           WHERE foi.operation_type = %s
                               ...
                               AND fod.comment = %s
                       """
                params = ('0', MT5cloudTrader_user_accounts_4, "changjing4")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('1', MT5cloudTrader_user_accounts_2, MT5cloudTrader_MT5vps_ids_1, "changjing4")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('1', MT5cloudTrader_user_accounts_4, MT5cloudTrader_MT5vps_ids_3, "changjing4")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                    ...
                    WHERE instruction_type = %s
                        ...
                        AND max_lot_size = %s
                """
                params = ("1", "0", cloudMaster_id, "MT5自动化测试", "1.00", "0.10")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('0', MT5cloudTrader_user_accounts_4, "changjing5")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.comment = %s
                """
                params = ('0', MT5cloudTrader_user_accounts_2, "changjing7")
            ...
            with allure.step("查询复制订单详情数据"):
                ...
                sql = """
                            ...
                            WHERE foi.operation_type = %s
                                ...
                                AND fod.comment = %s
                        """
                params = ('0', MT5cloudTrader_user_accounts_4, "changjing7")
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                    ...
                    WHERE foi.operation_type = %s
                        ...
                        AND fod.trader_id = %s
                """
                params = ('1', MT5cloudTrader_user_accounts_2, "changjing7", MT5cloudTrader_MT5vps_ids_1)
            ...
            with allure.step("查询复制平仓订单数据"):
                ...
                sql = """
                            ...
                            WHERE foi.operation_type = %s
                                ...
                                AND fod.trader_id = %s
                        """
                params = ('1', MT5cloudTrader_user_accounts_4, "changjing7", MT5cloudTrader_MT5vps_ids_3)
