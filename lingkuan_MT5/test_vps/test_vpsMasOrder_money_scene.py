...
class TestVPSMasOrder_money_scene:
    ...
    class TestVPSOrderSend_Scence(APITestBase):
        ...
        def test_MT5vps_dbtrader_euqit(self, var_manager, db_transaction):
        ...
        def test_dbMT5vps_addsalve_euqit(self, var_manager, db_transaction):
        ...
        def test_MT5vps_dbtrader_euqit2(self, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
