# lingkuan_711/tests/test_create.py
import time
...
from lingkuan_711.commons.jsonpath_utils import *
...
class TestCreate_cloudTrader(APITestBase):
    ...
    def test_cloudMaster_list(self, var_manager, logged_session):
        cloudMaster_name = var_manager.get_variable("cloudMaster_name")
        # 1. 发送获取云策略ID请求
        params = {
            "name": cloudMaster_name,
            "groupId": "",
        }
        ...
        logging.info(f"云策略ID: {cloudMaster_id}")
