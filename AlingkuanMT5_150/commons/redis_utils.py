# AlingkuanMT5_150/commons/redis_utils.py
import redis
import json
from typing import Dict, Any, List
from AlingkuanMT5_150.config import ENV_CONFIG  # 导入配置数据
from AlingkuanMT5_150.commons.enums import Environment  # 导入现有枚举
