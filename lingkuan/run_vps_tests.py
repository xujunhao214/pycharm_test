...
def run_vps_tests(env: str = "test"):
    ...
    args = [
        ...
        "/www/python/jenkins/workspace/Documentatio_Test/lingkuan/test_cloudTrader/test_vps/test_create.py",
        # "/www/python/jenkins/workspace/Documentatio_Test/lingkuan/test_cloudTrader/test_vps/test_vps_Leakage_level.py",
        ...
        "/www/python/jenkins/workspace/Documentatio_Test/lingkuan/test_cloudTrader/test_vps/test_delete.py",
        "/www/python/jenkins/workspace/Documentatio_Test/lingkuan/test_cloudTrader/test_vps/test_delete_scene.py",
