...
import pytest
import time
from lingkuan_1112.conftest import var_manager
from lingkuan_1112.commons.api_base import *
from lingkuan_1112.commons.redis_utils import *
...
class TestcloudTrader_openandlevel:
    @allure.story("场景1：云策略列表-云策略复制下单-漏开")
    @allure.description("""
    ### 用例说明
    - 前置条件：有云策略和云跟单
    - 操作步骤：
    ...
    class TestcloudTrader_open1(APITestBase):
        ...
        def test_cloudTrader_BatchUpdate(self, class_random_str, var_manager, logged_session):
        ...
        def test_dbcloudTrader_BatchUpdate(self, class_random_str, var_manager, db_transaction):
        ...
        @allure.title("云策略-云策略列表-修改云跟单")
        def test_cloudTrader_BatchUpdate2(self, class_random_str, var_manager, logged_session):
        ...
        @allure.title("数据库校验-云策略列表-修改云跟单账号是否成功")
        def test_dbcloudTrader_BatchUpdate2(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 查询数据库验证是否修改成功"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                sql = f"SELECT * FROM follow_cloud_trader WHERE account = %s and cloud_id = %s"
        ...
        def test_dbcloudTrader_OrderSend(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                sql = f"""
                            SELECT 
        ...
        def test_dbcloudTrader_OrderClose(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                sql = f"""
                               SELECT 
    ...
    @allure.story("场景2：云策略列表-云策略复制下单-漏平")
    @allure.description("""
    ### 用例说明
    - 前置条件：有云策略和云跟单
    - 操作步骤：
    ...
    class TestcloudTrader_level2(APITestBase):
        ...
        def test_cloudTrader_OrderClose2(self, class_random_str, logged_session, var_manager):
    ...
    @allure.story("场景3：交易下单-云策略复制下单-漏开")
    @allure.description("""
    ### 用例说明
    - 前置条件：有云策略和云跟单
    - 操作步骤：
    ...
    @allure.story("场景4：交易下单-云策略复制下单-漏平")
    @allure.description("""
    ### 用例说明
    - 前置条件：有云策略和云跟单
    - 操作步骤：
    ...
    @allure.story("场景5：交易下单-云策略复制下单-策略账号-策略状态关闭")
    @allure.description("""
    ### 用例说明
    - 前置条件：有云策略和云跟单
    - 操作步骤：
    ...
    class Testcloudstargy_addstatus5(APITestBase):
        ...
        def test_mascontrol_cloudTrader(self, class_random_str, var_manager, logged_session, encrypted_password):
        ...
        @allure.title("云策略-云策略列表-修改策略账号信息")
        def test_mascontrol_cloudTrader2(self, class_random_str, var_manager, logged_session, encrypted_password):
    ...
    @allure.story("场景6：交易下单-云策略复制下单-云策略-策略状态关闭")
    @allure.description("""
    ### 用例说明
    - 前置条件：有云策略和云跟单
    - 操作步骤：
    ...
    class Testcloudstargy_status6(APITestBase):
        @allure.title("云策略-云策略列表-修改策略账号信息")
        def test_mascontrol_cloudMaster(self, class_random_str, var_manager, logged_session, encrypted_password):
        ...
        @allure.title("云策略-云策略列表-修改策略账号信息")
        def test_mascontrol_cloudMaster2(self, class_random_str, var_manager, logged_session, encrypted_password):
