...
from lingkuan_702.commons.session import EnvironmentSession, Environment
from lingkuan_702.commons.variable_manager import VariableManager
from lingkuan_702.commons.test_tracker import TestResultTracker  # 新增：测试结果追踪器
from lingkuan_702.commons.feishu_notification import send_feishu_notification  # 新增：飞书通知
from pathlib import Path
from lingkuan_702.commons.test_tracker import TestResultTracker
import sys
import os
...
ENV_CONFIG = {
    Environment.TEST: {
        ...
        "data_source_dir": "lingkuan_702/VAR"
    },
    Environment.PROD: {
        "base_url": "http://39.99.136.49:9000",
        "vps_url": "http://39.99.136.49:9001",
