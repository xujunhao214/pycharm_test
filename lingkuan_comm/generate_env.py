...
ENV_CONFIG = {
    Environment.TEST.value: {
        ...
        "docuvps_url": "http://39.99.136.49/vps",
    ...
    Environment.UAT.value: {
        ...
        "browser_version": "自研跟单1.4.2",
        "vpsbase_url": "https://uat.atcp.top/api",
        "docuvps_url": "https://39.101.181.190/vps",
...
def generate_environment_xml(output_dir, env_value):
    ...
    try:
        ...
        add_param(environment, "vpsbase_url", env_config["vpsbase_url"])
        add_param(environment, "docuvps_url", env_config["docuvps_url"])
