...
class TestCreate_cloudTrader(APIVPSBase):
    ...
    def test_dbquery_importuser(self, var_manager, dbvps_transaction):
        ...
        with allure.step("2. 提取数据库数据"):
            ...
            print(f"提取到用户ID列表: {cloudTrader_user_ids}")
    ...
    def test_user_hangVps(self, var_manager, logged_vps):
    ...
    def test_dbimport_addSlave(self, var_manager, dbvps_transaction):
    ...
    def test_create_cloudgroup(self, logged_vps, var_manager):
    ...
    def test_dbquery_cloudgroup(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
            add_cloudgroup = var_manager.get_variable("add_cloudgroup")
    ...
    def test_create_cloudMaster(self, var_manager, logged_vps):
    ...
    def test_dbcreate_cloudTrader(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
            db_data = self.query_database(
                dbvps_transaction,
    ...
    def test_mascontrol_cloudTrader(self, var_manager, logged_vps):
        # 1. 发送新增策略账号请求
    ...
    def test_dbmascontrol_cloudTrader(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
    ...
    def test_manager_cloudTrader(self, var_manager, logged_vps):
        # 1. 发送新增策略账号请求
        cloudMaster_id = var_manager.get_variable("cloudMaster_id")
    ...
    def test_dbmanager_trader(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
            cloudTrader_user_accounts_3 = var_manager.get_variable("cloudTrader_user_accounts_3")
    ...
    def test_cloudTrader_cloudBatchAdd(self, var_manager, logged_vps):
        # 1. 发送新增策略账号请求
        cloudMaster_id = var_manager.get_variable("cloudMaster_id")
    ...
    def test_dbcloudTrader_cloudBatchAdd(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
    ...
    def test_create_variety(self, logged_vps, var_manager):
        # 1. 读取CSV文件
    ...
    def test_dbquery_variety(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
            add_variety = var_manager.get_variable("add_variety")
            # 从变量中获取表名和模板名
            ...
            # 执行带时间范围的查询
            db_data = self.query_database(dbvps_transaction, sql, params)
    ...
    def test_create_variety2(self, logged_vps, var_manager):
        # 1. 读取CSV文件
        add_variety = var_manager.get_variable("add_variety")
    ...
    def test_dbquery_variety2(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
            add_variety = var_manager.get_variable("add_variety")
            # 从变量中获取表名和模板名
    ...
    def test_create_handcloudMaster(self, var_manager, logged_vps):
        cloudTrader_group_id = var_manager.get_variable("cloudTrader_group_id")
        with allure.step("1. 发送新增云策略的请求接口"):
            data = {
                "name": "自动化测试_手动下单",
    ...
    def test_dbcreate_handcloudMaster(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
            db_data = self.query_database(
                dbvps_transaction,
                f"SELECT * FROM follow_cloud_master WHERE name = %s",
    ...
    def test_create_handcloudBatchAdd(self, var_manager, logged_vps):
        cloudTrader_vps_ids_3 = var_manager.get_variable("cloudTrader_vps_ids_3")
    ...
    def test_dbcreate_handcloudBatchAdd(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否新增成功"):
            cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
            cloudMaster_id_hand = var_manager.get_variable("cloudMaster_id_hand")
            db_data = self.query_database(
