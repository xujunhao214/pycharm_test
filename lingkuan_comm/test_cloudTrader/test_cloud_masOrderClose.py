...
import requests
from lingkuan_comm.commons.jsonpath_utils import JsonPathUtils
from lingkuan_comm.public_function.cloud_public import cloud_PublicUtils
...
class TestVPSMasOrderclose:
    ...
    - 预期结果：平仓的品种功能正确
    """)
    class TestcloudtradingOrders1(APIVPSBase):
        @allure.title("云策略-策略账号交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
        ...
        @allure.title("云策略-策略账号交易下单-交易平仓-币种错误")
        def test_copy_order_close(self, var_manager, logged_vps):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            # 发送平仓请求
            data = {
                "flag": 0,
        ...
        def test_copy_order_close2(self, var_manager, logged_vps):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            masOrderSend = var_manager.get_variable("masOrderSend")
            # 发送平仓请求
            data = {
        ...
        def test_dbquery_orderSendclose2(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_2 = var_manager.get_variable("cloudTrader_user_accounts_2")
                sql = f"""
                            SELECT 
        ...
        def test_dbquery_addsalve_orderSendclose2(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                cloudTrader_vps_ids_3 = var_manager.get_variable("cloudTrader_vps_ids_3")
                sql = f"""
    ...
    @allure.description("""
       ...
       - 预期结果：平仓的停止功能正确
       """)
    class TestcloudtradingOrders2(APIVPSBase):
        @allure.title("云策略-策略账号交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送云策略-策略账号交易下单-复制下单请求
            global symbol
        ...
        def test_copy_order_stopOrder(self, var_manager, logged_vps):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            # 发送停止请求
            params = {
                "orderNo": "",
    ...
    - 预期结果：平仓的订单方向功能正确
    """)
    class TestVPStradingOrders3(APIVPSBase):
        @allure.title("修改跟单账号为反向跟单")
        def test_follow_updateSlave(self, var_manager, logged_vps, encrypted_password):
        ...
        @allure.title("云策略-策略账号交易下单-交易平仓-正常平仓")
        def test_copy_order_close3(self, var_manager, logged_vps):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            # 发送平仓请求
            data = {
                "flag": 0,
    ...
    - 预期结果：平仓的订单方向功能正确
    """)
    class TestcloudtradingOrders4(APIVPSBase):
        @allure.title("修改跟单账号为反向跟单")
        def test_follow_updateSlave(self, var_manager, logged_vps, encrypted_password):
            with allure.step("1. 修改跟单方向为反向"):
                # 1. 修改跟单方向为反向followDirection 1:反向 0：正向
    ...
    - 预期结果：平仓的订单方向功能正确
    """)
    class TestcloudtradingOrders5(APIVPSBase):
    ...
    - 预期结果：平仓的订单数量功能正确
    """)
    class TestcloudtradingOrders6(APIVPSBase):
        @allure.title("云策略-策略账号交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送云策略-策略账号交易下单-复制下单请求
            global symbol
    ...
    - 预期结果：平仓的订单数量功能正确
    """)
    class TestcloudtradingOrders7(APIVPSBase):
        @allure.title("云策略-策略账号交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送云策略-策略账号交易下单-复制下单请求
            global symbol
        ...
        @allure.title("云策略-策略账号交易下单-交易平仓-平仓订单数0")
        def test_copy_order_close(self, var_manager, logged_vps):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            # 发送平仓请求
            data = {
    ...
    - 预期结果：平仓的订单类型功能正确
    """)
    class TestcloudtradingOrders8(APIVPSBase):
        @allure.title("云策略-策略账号交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送云策略-策略账号交易下单-复制下单请求
            global symbol
    ...
    class TestcloudtradingOrders9(APIVPSBase):
    ...
    - 预期结果：平仓的订单类型功能正确
    """)
    class TestcloudtradingOrders10(APIVPSBase):
        @allure.title("云策略-策略账号交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送云策略-策略账号交易下单-复制下单请求
            global symbol
    ...
    - 预期结果：平仓的订单备注功能正确
    """)
    class TestcloudtradingOrders11(APIVPSBase):
        @allure.title("云策略-策略账号交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送云策略-策略账号交易下单-复制下单请求
            global symbol
