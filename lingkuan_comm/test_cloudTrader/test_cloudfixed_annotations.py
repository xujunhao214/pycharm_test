...
""")
class TestCloudStrategyOrderRemark(APIVPSBase):
    """整合云策略三种备注场景的测试类"""

    # -------------------------- 场景1：策略有备注，跟单无备注 --------------------------
    @allure.story("场景1：策略有固定注释，跟单无固定注释")
    @allure.title("修改云策略信息（关闭跟单备注）")
    def test_scenario1_update_strategy(self, var_manager, logged_vps):
    ...
    def test_scenario1_update_follower(self, var_manager, logged_vps):
    ...
    def test_scenario1_place_order(self, logged_vps, var_manager):
    ...
    def test_scenario1_verify_remark(self, var_manager, dbvps_transaction):
    ...
    def test_scenario1_close_orders(self, logged_vps, var_manager):
    ...
    @allure.title("修改云策略信息（关闭跟单备注）")
    def test_scenario2_update_strategy(self, var_manager, logged_vps):
        with allure.step("发送修改云策略请求"):
            new_user = var_manager.get_variable("new_user")
            cloudTrader_traderList_2 = var_manager.get_variable("cloudTrader_traderList_2")
            cloudMaster_id = var_manager.get_variable("cloudMaster_id")
    ...
    def test_scenario2_update_follower(self, var_manager, logged_vps):
        with allure.step("发送修改跟单账号请求"):
            cloudTrader_traderList_4 = var_manager.get_variable("cloudTrader_traderList_4")
            cloudMaster_id = var_manager.get_variable("cloudMaster_id")
            cloudTrader_traderList_2 = var_manager.get_variable("cloudTrader_traderList_2")
    ...
    @allure.story("场景2：策略有固定注释，跟单有固定注释")
    @allure.title("云策略账号复制下单")
    def test_scenario2_place_order(self, logged_vps, var_manager):
        with allure.step("发送开仓请求"):
            self.cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            data = {
                "traderList": [self.cloudTrader_user_ids_2],
    ...
    def test_scenario2_verify_remark(self, var_manager, dbvps_transaction):
        with allure.step("查询订单备注信息"):
            cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
            sql = """
                SELECT fod.comment 
    ...
    @allure.story("场景2：策略有固定注释，跟单有固定注释")
    @allure.title("策略和平仓操作")
    def test_scenario2_close_orders(self, logged_vps, var_manager):
        with allure.step("策略账号平仓"):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            response = self.send_post_request(
                logged_vps,
    ...
    def test_scenario3_update_strategy(self, var_manager, logged_vps):
        with allure.step("发送修改云策略请求"):
            new_user = var_manager.get_variable("new_user")
            cloudTrader_traderList_2 = var_manager.get_variable("cloudTrader_traderList_2")
            cloudMaster_id = var_manager.get_variable("cloudMaster_id")
    ...
    @allure.story("场景3：策略开启订单备注，跟单无固定注释")
    @allure.title("修改跟单账号（无固定注释）")
    def test_scenario3_update_follower(self, var_manager, logged_vps):
        with allure.step("发送修改跟单账号请求"):
            cloudTrader_traderList_4 = var_manager.get_variable("cloudTrader_traderList_4")
            cloudMaster_id = var_manager.get_variable("cloudMaster_id")
            cloudTrader_traderList_2 = var_manager.get_variable("cloudTrader_traderList_2")
    ...
    @allure.story("场景3：策略开启订单备注，跟单无固定注释")
    @allure.title("云策略账号复制下单")
    def test_scenario3_place_order(self, logged_vps, var_manager):
        with allure.step("发送开仓请求"):
            self.cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            data = {
                "traderList": [self.cloudTrader_user_ids_2],
    ...
    def test_scenario3_verify_remark(self, var_manager, dbvps_transaction):
        with allure.step("查询订单备注信息"):
            cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
            sql = """
                SELECT fod.comment 
    ...
    @allure.story("场景3：策略开启订单备注，跟单无固定注释")
    @allure.title("策略和平仓操作")
    def test_scenario3_close_orders(self, logged_vps, var_manager):
        with allure.step("策略账号平仓"):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            response = self.send_post_request(
                logged_vps,
