...
from lingkuan_comm.public_function.cloud_public import *
...
class TestCloudCoreFunctionality:
    ...
    - 预期结果：平仓的停止功能正确
    """)
    class TestMasOrderSend1(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
        ...
        def test_copy_close_symbol(self, logged_vps, var_manager):
            """执行复制下单的平仓操作并验证结果"""
        ...
        def test_copy_verify_close_dbsymbol(self, var_manager, dbvps_transaction):
        ...
        def test_copy_close_order(self, logged_vps, var_manager):
            """执行复制下单的平仓操作并验证结果"""
            with allure.step("发送复制下单平仓请求"):
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                cloudTrader_traderList_4 = var_manager.get_variable("cloudTrader_traderList_4")
        ...
        def test_copy_close_cloudStopOrder(self, logged_vps, var_manager):
        ...
        @allure.title("数据库校验-复制下单平仓数据-数据校验")
        def test_copy_verify_close_db(self, var_manager, dbvps_transaction):
            """验证复制下单平仓后数据库中的订单数据正确性"""
            with allure.step("查询复制平仓订单数据"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                cloudTrader_vps_ids_3 = var_manager.get_variable("cloudTrader_vps_ids_3")
        ...
        @allure.title("云策略-复制下单平仓操作")
        def test_copy_close_order2(self, logged_vps, var_manager):
            """执行复制下单的平仓操作并验证结果"""
            with allure.step("发送复制下单平仓请求"):
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                cloudTrader_traderList_4 = var_manager.get_variable("cloudTrader_traderList_4")
...
class TestCloudFollowDirection:
    ...
    - 预期结果：平仓的订单方向功能正确
    """)
    class TestMasOrderSend2(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
        ...
        @allure.title("数据库校验-复制下单平仓数据-数据校验")
        def test_copy_verify_close_db2(self, var_manager, dbvps_transaction):
            """验证复制下单平仓后数据库中的订单数据正确性"""
            with allure.step("查询复制平仓订单数据"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                cloudTrader_vps_ids_3 = var_manager.get_variable("cloudTrader_vps_ids_3")
    ...
    - 预期结果：平仓的订单方向功能正确
    """)
    class TestMasOrderSend3(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
...
class TestCloudOrderQuantityControl:
    ...
    - 预期结果：平仓的订单数量功能正确
    """)
    class TestMasOrderSend4(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
...
class TestCloudOrderType:
    ...
    - 预期结果：平仓的订单类型功能正确
    """)
    class TestMasOrderSend5(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
    ...
    """)
    # @pytest.mark.skipif(True, reason=SKIP_REASON)
    class TestMasOrderSend6(APIVPSBase):
    ...
    - 预期结果：平仓的订单类型功能正确
    """)
    class TestMasOrderSend7(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
...
class TestCloudCloseRemark:
    ...
    - 预期结果：平仓的订单备注功能正确
    """)
    class TestMasOrderSend8(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
...
class TestCloudClose:
    ...
    """)
    class TestMasOrderSend9(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
        ...
        @allure.title("云策略-复制下单平仓操作-平仓1个")
        def test_copy_close_order3(self, logged_vps, var_manager):
            """执行复制下单的平仓操作并验证结果"""
            with allure.step("发送复制下单平仓请求"):
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                cloudTrader_traderList_4 = var_manager.get_variable("cloudTrader_traderList_4")
        ...
        @allure.title("数据库校验-复制下单平仓数据-数据校验")
        def test_copy_verify_close_db3(self, var_manager, dbvps_transaction):
            """验证复制下单平仓后数据库中的订单数据正确性"""
            with allure.step("查询复制平仓订单数据"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                cloudTrader_vps_ids_3 = var_manager.get_variable("cloudTrader_vps_ids_3")
    ...
    """)
    # @pytest.mark.skipif(True, reason=SKIP_REASON)
    class TestMasOrderSend10(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
    ...
    """)
    # @pytest.mark.skipif(True, reason=SKIP_REASON)
    class TestMasOrderSend11(APIVPSBase):
        @allure.title("云策略-复制下单操作")
        def test_copy_place_order(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
            with allure.step("发送复制下单请求"):
