...
class Testcloudtrader_moneyandscene:
    ...
    - 预期结果：三个账号的币种手数正确
    """)
    class Testcloudtrader_money(APIVPSBase):
        # @pytest.mark.skip(reason=SKIP_REASON)
        @allure.title("账号管理-账号列表-修改用户")
        def test_update_user(self, logged_vps, var_manager, encrypted_password):
            # 1. 发送修改用户请求
        ...
        def test_dbupdate_user(self, var_manager, dbvps_transaction):
        ...
        def test_dbtrader_cfda(self, var_manager, dbvps_transaction):
        ...
        def test_dbtrader_cfdp(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
        ...
        def test_dbtrader_cfdmin(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
        ...
        def test_bargain_masOrderClose(self, logged_vps, var_manager):
            cloudTrader_user_ids_2 = var_manager.get_variable("cloudTrader_user_ids_2")
            # 1. 发送平仓请求
            data = {
                "isCloseAll": 1,
        ...
        def test_dbclose_cfda(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_8 = var_manager.get_variable("cloudTrader_user_accounts_8")
                sql = f"""
                        SELECT 
        ...
        def test_dbclose_cfdp(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_9 = var_manager.get_variable("cloudTrader_user_accounts_9")
                sql = f"""
                        SELECT 
        ...
        def test_dbclose_cfdmin(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_10 = var_manager.get_variable("cloudTrader_user_accounts_10")
                sql = f"""
                        SELECT 
    ...
    - 预期结果：三个账号的手数正确
    """)
    class Testcloudtrader_Scence(APIVPSBase):
        @allure.title("账号管理-交易下单-云策略账号复制下单")
        def test_bargain_masOrderSend(self, logged_vps, var_manager):
            # 1. 发送云策略复制下单请求
            global cloudTrader_user_ids_2
        ...
        def test_dbdetail_followParam5(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
        ...
        def test_dbdetail_templateId3(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
        ...
        def test_dbtrader_euqit(self, var_manager, dbvps_transaction):
        ...
        def test_dbaddsalve_euqit(self, var_manager, dbvps_transaction):
        ...
        def test_dbtrader_euqit2(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
        ...
        def test_dbclose_followParam5(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_5 = var_manager.get_variable("cloudTrader_user_accounts_5")
                sql = f"""
                        SELECT 
        ...
        def test_dbclose_templateId3(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_6 = var_manager.get_variable("cloudTrader_user_accounts_6")
        ...
        def test_dbclose_euqit(self, var_manager, dbvps_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                cloudTrader_user_accounts_7 = var_manager.get_variable("cloudTrader_user_accounts_7")
