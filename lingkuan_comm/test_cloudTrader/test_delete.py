...
class TestDelete_cloudTrader(APIVPSBase):
    # @pytest.mark.skip(reason=SKIP_REASON)
    @allure.title("云策略-云策略列表-批量删除云跟单账号")
    def test_delete_cloudBatchDelete(self, logged_vps, var_manager):
        # 1. 获取账号总数和所有ID
    ...
    def test_dbdelete_cloudBatchDelete(self, var_manager, dbvps_transaction):
        # 1. 获取账号总数和所有ID
        cloudTrader_user_count = var_manager.get_variable("cloudTrader_user_count", 0)
        if cloudTrader_user_count < 0:
    ...
    def test_delete_handcloudBatchAdd(self, logged_vps, var_manager):
        # 1. 发送删除删除云跟单账号请求
    ...
    def test_dbdelete_handcloudBatchAdd(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
            cloudTrader_traderList_handid = var_manager.get_variable("cloudTrader_traderList_handid")
    ...
    def test_delete_managercloudTrader(self, logged_vps, var_manager):
        # 1. 删除云策略manager账号请求
    ...
    def test_dbdelete_managercloudTrader(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
            cloudTrader_traderList_3 = var_manager.get_variable("cloudTrader_traderList_3")
    ...
    def test_delete_cloudTrader(self, logged_vps, var_manager):
        # 1. 删除云策略manager账号请求
    ...
    def test_dbdelete_cloudTrader(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
    ...
    def test_user_belowVps(self, var_manager, logged_vps):
    ...
    def test_dbdelete_belowVps(self, var_manager, dbvps_transaction):
        # 1. 获取账号总数和所有账号信息
        cloudTrader_user_count = var_manager.get_variable("cloudTrader_user_count", 0)
        ...
        for i in range(2, cloudTrader_user_count + 1):  # 循环索引2-10（共9次）
            with allure.step(f"验证第{i}个账号是否下架成功"):
                ...
                db_data_sub = self.query_database(dbvps_transaction, sql_sub, (account,))
    ...
    def test_deleteTemplate(self, logged_vps, var_manager):
        """测试删除用户接口"""
        # 1. 发送删除品种请求
    ...
    def test_dbdelete_template(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
    ...
    def test_deleteTemplate2(self, logged_vps, var_manager):
        """测试删除用户接口"""
        # 1. 发送删除品种请求
    ...
    def test_dbdelete_template2(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
            add_variety = var_manager.get_variable("add_variety")
    ...
    def test_delete_cloudMaster(self, logged_vps, var_manager):
        # 1. 发送删除云策略请求
    ...
    def test_dbdelete_cloudMaster(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
            cloudMaster_id = var_manager.get_variable("cloudMaster_id")
    ...
    def test_delete_cloudMaster_hand(self, logged_vps, var_manager):
        # 1. 发送删除云策略请求
    ...
    def test_dbdelete_cloudMaster_hand(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
            cloudMaster_id_hand = var_manager.get_variable("cloudMaster_id_hand")
    ...
    def test_deletecloudgroup(self, logged_vps, var_manager):
        # 1. 发送删除云策略组别请求
    ...
    def test_dbdelete_cloudgroup(self, var_manager, dbvps_transaction):
        with allure.step("1. 查询数据库验证是否删除成功"):
            cloudTrader_group_id = var_manager.get_variable("cloudTrader_group_id")
