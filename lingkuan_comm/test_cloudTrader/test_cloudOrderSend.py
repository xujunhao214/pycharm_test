...
class TestCloudStrategyOrder:
    ...
    class TestMasOrderSend5(APIVPSBase):
        ...
        def test_cloudTrader_cloudStopOrder(self, logged_vps, var_manager):
            """执行云策略复制下单操作并验证请求结果"""
        ...
        @allure.title("数据库校验-复制下单数据")
        def test_copy_verify_db2(self, var_manager, dbvps_transaction):
            """验证复制下单后数据库中的订单数据正确性"""
            with allure.step("查询复制订单详情数据"):
                cloudTrader_user_accounts_4 = var_manager.get_variable("cloudTrader_user_accounts_4")
                sql = """
    ...
    class TestMasOrderSend6(APIVPSBase):
        ...
        def test_allocation_place_order(self, logged_vps, var_manager):
            """执行云策略分配下单操作并验证请求结果"""
        ...
        def test_allocation_verify_db(self, var_manager, dbvps_transaction):
            """验证分配下单后数据库中的订单数据正确性"""
        ...
        def test_allocation_close_order(self, logged_vps, var_manager):
            """执行分配下单的平仓操作并验证结果"""
        ...
        def test_allocation_verify_close_db(self, var_manager, dbvps_transaction):
