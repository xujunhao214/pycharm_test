...
from lingkuan_comm.commons.wait_utils import wait_for_condition
...
class APIVPSBase:
    ...
    # ------------------------------ 数据库操作（异常分层优化） ------------------------------
    def query_database(self, dbvps_transaction: pymysql.connections.Connection,
                       sql: str,
                       params: tuple = (),
    ...
    # ------------------------------ 其他辅助方法（异常分层优化） ------------------------------
    def wait_for_api_condition(self, logged_vps, method, url, params=None, json_data=None,
