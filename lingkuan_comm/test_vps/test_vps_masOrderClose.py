...
class TestVPSMasOrderclose:
    ...
    - 预期结果：平仓的品种功能正确
    """)
    class TestVPStradingOrders1(APIVPSBase):
    ...
    - 预期结果：平仓的停止功能正确
    """)
    class TestVPStradingOrders2(APIVPSBase):
        @allure.title("VPS交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送VPS交易下单-复制下单请求
            global symbol
        ...
        def test_copy_verify_db(self, var_manager, dbvps_transaction):
            """验证复制下单后数据库中的订单数据正确性"""
    ...
    - 预期结果：平仓的订单方向功能正确
    """)
    class TestVPStradingOrders4(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("修改跟单账号为反向跟单")
        def test_follow_updateSlave(self, var_manager, logged_vps, encrypted_password):
            with allure.step("1. 修改跟单方向为反向"):
    ...
    - 预期结果：平仓的订单方向功能正确
    """)
    class TestVPStradingOrders5(APIVPSBase):
        @pytest.mark.url("vps")
    ...
    - 预期结果：平仓的订单数量功能正确
    """)
    class TestVPStradingOrders6(APIVPSBase):
        @allure.title("VPS交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送VPS交易下单-复制下单请求
            global symbol
    ...
    - 预期结果：平仓的订单数量功能正确
    """)
    class TestVPStradingOrders7(APIVPSBase):
        @allure.title("VPS交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送VPS交易下单-复制下单请求
            global symbol
    ...
    - 预期结果：平仓的订单类型功能正确
    """)
    class TestVPStradingOrders8(APIVPSBase):
        @allure.title("VPS交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送VPS交易下单-复制下单请求
            global symbol
    ...
    class TestVPStradingOrders9(APIVPSBase):
    ...
    - 预期结果：平仓的订单类型功能正确
    """)
    class TestVPStradingOrders10(APIVPSBase):
        @allure.title("VPS交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送VPS交易下单-复制下单请求
            global symbol
    ...
    - 预期结果：平仓的订单备注功能正确
    """)
    class TestVPStradingOrders11(APIVPSBase):
        @allure.title("VPS交易下单-复制下单请求")
        def test_copy_order_send(self, logged_vps, var_manager):
            # 发送VPS交易下单-复制下单请求
            global symbol
