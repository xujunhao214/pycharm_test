...
class TestVPSOrdersend:
    ...
    - 预期结果：账号的数据正确
    """)
    class TestVPSOrderSend1(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("修改跟单账号")
    ...
    - 预期结果：账号的数据正确
    """)
    class TestVPSOrderSend2(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("跟单软件看板-VPS数据-策略开仓")
        def test_trader_orderSend(self, var_manager, logged_vps):
            # 1. 发送策略开仓请求
    ...
    - 预期结果：账号的数据正确
    """)
    class TestVPSOrderSend3(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("跟单软件看板-VPS数据-策略开仓")
        def test_trader_orderSend(self, var_manager, logged_vps):
            # 1. 发送策略开仓请求
    ...
    - 预期结果：账号的数据正确
    """)
    class TestVPSOrderSend4(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("跟单软件看板-VPS数据-策略开仓")
        def test_trader_orderSend(self, var_manager, logged_vps):
            # 1. 发送策略开仓请求
    ...
    - 预期结果：云策略下单的停止功能正确
    """)
    class TestVPSOrderSend5(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("跟单软件看板-VPS数据-策略开仓")
        def test_trader_orderSend(self, var_manager, logged_vps):
            # 1. 发送策略开仓请求
        ...
        def test_scenario_trader_stopOrder(self, var_manager, logged_vps):
            # 发送策略开仓停止请求
            vps_trader_id = var_manager.get_variable("vps_trader_id")
            params = {
                "type": "0",
    ...
    - 预期结果：账号的数据正确，权重正确
    """)
    class TestVPSOrderSend6(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("跟单软件看板-VPS数据-策略开仓")
        def test_trader_orderSend(self, var_manager, logged_vps):
            # 1. 发送策略开仓请求
    ...
    """)
    class TestVPSOrderSend7(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("跟单软件看板-VPS数据-策略开仓")
        def test_trader_orderSend(self, var_manager, logged_vps):
            # 1. 发送策略开仓请求
    ...
    - 预期结果：账号的数据正确
    """)
    class TestVPSOrderSend10(APIVPSBase):
        @pytest.mark.url("vps")
    ...
    - 预期结果：账号的数据正确
    """)
    class TestVPSOrderSend11(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("修改跟单账号-手数取余-取小数")
        def test_follow_updateSlave(self, var_manager, logged_vps, encrypted_password):
            with allure.step("1. 修改跟单账号"):
    ...
    - 预期结果：账号的数据正确
    """)
    class TestVPSOrderSend12(APIVPSBase):
        @pytest.mark.url("vps")
        @allure.title("修改跟单账号-手数取余-取小数")
        def test_follow_updateSlave(self, var_manager, logged_vps, encrypted_password):
            with allure.step("1. 修改跟单账号"):
