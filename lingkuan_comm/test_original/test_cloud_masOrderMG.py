...
每种模式均包含下单、数据校验和平仓流程
""")
class TestCloudStrategyOrderSend(APIVPSBase):
    ...
    def test_allocation_place_order(self, logged_vps, var_manager):
        ...
        self.cloudTrader_user_ids_3 = var_manager.get_variable("cloudTrader_user_ids_3")

        request_data = {
            "traderList": [self.cloudTrader_user_ids_3],
            "type": 0,
            "tradeType": 0,
    ...
    def test_allocation_verify_open_db(self, var_manager, dbvps_transaction):
        ...
        sql = """
            ...
            WHERE foi.operation_type = %s
                AND fod.account = %s
        """
        params = ('0', cloudTrader_user_accounts_3)
    ...
    def test_allocation_verify_close_db(self, var_manager, dbvps_transaction):
        ...
        sql = """
            ...
            WHERE foi.operation_type = %s
                ...
                AND fod.trader_id = %s
        """
        params = ('1', cloudTrader_user_accounts_3, cloudTrader_vps_ids_2)
    ...
    def test_copy_verify_open_db(self, var_manager, dbvps_transaction):
        cloudTrader_user_accounts_3 = var_manager.get_variable("cloudTrader_user_accounts_3")
        sql = """
            SELECT 
                fod.size,
