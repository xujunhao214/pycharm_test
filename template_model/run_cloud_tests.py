...
def run_cloud_tests(env: str = "test"):
    ...
    args = [
        "-s", "-v",
        f"--env={env}",
        f"--test-group=community",
        f"--alluredir={report_dir}",
        "--clean-alluredir",

        "test_community/test_create.py",
        "test_community_vps/test_create.py",
        # "test_community_vps/test_vps_openclose.py",
        # "test_community/test_oac_proportion.py",
        # "test_community/test_oac_number.py",
        # "test_community/test_oac_equit.py",
        # "test_community/test_trader.py",
        # "test_community/test_follow.py",
        # "test_community/test_historical_orders.py",
        # "test_community/test_realtime_add.py",
        # "test_community/test_follow_dividend.py",
