...
def run_cloud_tests(env: str = "test"):
    ...
    args = [
        ...
        "/www/python/jenkins/workspace/Documentatio_Test/lingkuan_model/test_cloudTrader/test_cloudstartegy_addstatus.py",
        "/www/python/jenkins/workspace/Documentatio_Test/lingkuan_model/test_cloudTrader/test_cloudstartegy_status.py",
