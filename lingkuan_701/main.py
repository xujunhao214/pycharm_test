...
def run_tests(env: str = "test"):
    ...
    args = [
        ...
        # "test_youhua/test_delete_user.py",  # 测试用例目录
        ...
        "test_youhua/test_lianxi2.py",  # 测试用例目录
        # "test_youhua/test_vps.py",  # 测试用例目录
        # "test_youhua/test_trade_order.py",  # 测试用例目录
        # "test_youhua/test_vps_ordersend_scene.py",  # 测试用例目录
