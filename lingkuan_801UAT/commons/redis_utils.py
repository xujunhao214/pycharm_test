# lingkuan_801UAT/commons/redis_utils.py
import redis
import json
from typing import Dict, Any, List
from lingkuan_801UAT.config import ENV_CONFIG  # 导入配置数据
from lingkuan_801UAT.commons.enums import Environment  # 导入现有枚举
