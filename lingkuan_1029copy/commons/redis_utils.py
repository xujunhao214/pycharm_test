# lingkuan_1029copy/commons/redis_utils.py
import redis
import json
from typing import Dict, Any, List
from lingkuan_1029copy.config import ENV_CONFIG  # 导入配置数据
from lingkuan_1029copy.commons.enums import Environment  # 导入现有枚举
