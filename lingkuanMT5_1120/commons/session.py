...
from lingkuanMT5_1120.conftest import *
...
class EnvironmentSession(requests.Session):
    ...
    def __init__(self, environment: Environment, base_url: str, MT5vps_url=None):
        ...
        self.MT5vps_url = MT5vps_url or ENV_CONFIG[environment].get("MT5vps_url")
    ...
    def use_MT5vps_url(self):
        """切换到MT5vps_url"""
        self.current_url = self.MT5vps_url
    ...
    def build_url(self, path: str) -> str:
        ...
        2. 命名URL（如"MT5vps_api/subcontrol"）
