...
@allure.feature("跟随云策略账号订单备注的场景校验")
class TestCloudremark:
    ...
    class TestCloudStrategyOrderRemark1(APITestBase):
        ...
        def test_scenario1_update_follower(self, class_random_str, var_manager, logged_session):
            with allure.step("发送修改跟单账号请求"):
                ...
                data = [{
                    "traderList": [MT5cloudTrader_traderList_4],
        ...
        @allure.title("策略平仓操作")
        def test_scenario1_close_orders(self, class_random_str, logged_session, var_manager):
    ...
    class TestCloudStrategyOrderRemark2(APITestBase):
        ...
        def test_scenario2_update_follower(self, class_random_str, var_manager, logged_session):
            with allure.step("发送修改跟单账号请求"):
                MT5cloudTrader_traderList_4 = var_manager.get_variable("MT5cloudTrader_traderList_4")
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                MT5cloudTrader_traderList_2 = var_manager.get_variable("MT5cloudTrader_traderList_2")
        ...
        @allure.title("云策略账号复制下单")
        def test_scenario2_place_order(self, class_random_str, logged_session, var_manager):
            with allure.step("发送开仓请求"):
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                MT5cloudTrader_traderList_2 = var_manager.get_variable("MT5cloudTrader_traderList_2")
        ...
        @allure.title("策略平仓操作")
        def test_scenario2_close_orders(self, class_random_str, logged_session, var_manager):
            with allure.step("策略账号平仓"):
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                MT5cloudTrader_traderList_2 = var_manager.get_variable("MT5cloudTrader_traderList_2")
                response = self.send_post_request(
    ...
    class TestCloudStrategyOrderRemark3(APITestBase):
        ...
        @allure.title("修改跟单账号-无固定注释")
        def test_scenario3_update_follower(self, class_random_str, var_manager, logged_session):
            with allure.step("发送修改跟单账号请求"):
                MT5cloudTrader_traderList_4 = var_manager.get_variable("MT5cloudTrader_traderList_4")
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                MT5cloudTrader_traderList_2 = var_manager.get_variable("MT5cloudTrader_traderList_2")
        ...
        @allure.title("云策略账号复制下单")
        def test_scenario3_place_order(self, class_random_str, logged_session, var_manager):
            with allure.step("发送开仓请求"):
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                MT5cloudTrader_traderList_2 = var_manager.get_variable("MT5cloudTrader_traderList_2")
        ...
        @allure.title("策略平仓操作")
        def test_scenario3_close_orders(self, class_random_str, logged_session, var_manager):
            with allure.step("策略账号平仓"):
                cloudMaster_id = var_manager.get_variable("cloudMaster_id")
                MT5cloudTrader_traderList_2 = var_manager.get_variable("MT5cloudTrader_traderList_2")
                response = self.send_post_request(
    ...
    class TestCloudStrategyOrderRemark4(APITestBase):
        ...
        def test_scenario1_place_order(self, class_random_str, logged_session, var_manager):
            with allure.step("发送开仓请求"):
                self.MT5cloudTrader_user_ids_2 = var_manager.get_variable("MT5cloudTrader_user_ids_2")
                data = {
