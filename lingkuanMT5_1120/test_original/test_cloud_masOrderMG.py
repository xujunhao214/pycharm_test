...
class TestCloudStrategyOrderSend(APITestBase):
    ...
    def test_allocation_verify_open_db(self, class_random_str, var_manager, db_transaction):
    ...
    def test_copy_verify_open_db(self, class_random_str, var_manager, db_transaction):
        MT5cloudTrader_user_accounts_3 = var_manager.get_variable("MT5cloudTrader_user_accounts_3")
        sql = """
            SELECT 
                fod.size,
