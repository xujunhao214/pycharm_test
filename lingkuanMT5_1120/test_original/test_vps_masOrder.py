...
class TestVPStradingOrders(APITestBase):
    ...
    def test_allocation_order_send(self, class_random_str, logged_session, var_manager):
        # 发送VPS分配下单请求
    ...
    def test_allocation_open_verify(self, class_random_str, var_manager, db_transaction):
    ...
    def test_allocation_order_close(self, class_random_str, var_manager, logged_session):
        MT5vps_user_ids_1 = var_manager.get_variable("MT5vps_user_ids_1")
        # 发送平仓请求
        data = {
            "isCloseAll": 1,
    ...
    def test_allocation_close_verify(self, class_random_str, var_manager, db_transaction):
    ...
    def test_copy_open_verify(self, class_random_str, var_manager, db_transaction):
        with allure.step("获取开仓订单数据"):
            MT5vps_user_accounts_1 = var_manager.get_variable("MT5vps_user_accounts_1")
            sql = """
                SELECT 
    ...
    def test_copy_close_verify(self, class_random_str, var_manager, db_transaction):
        with allure.step("获取平仓订单数据"):
            MT5vps_user_accounts_1 = var_manager.get_variable("MT5vps_user_accounts_1")
            MT5vps_addslave_id = var_manager.get_variable("MT5vps_addslave_id")
            sql = """
