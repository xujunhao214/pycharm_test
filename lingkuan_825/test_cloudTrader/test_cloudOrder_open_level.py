# lingkuan_825/tests/test_云策略_ordersend.py
import allure
import logging
import pytest
import time
...
from lingkuan_825.commons.redis_utils import *
...
class TestcloudTrader_openandlevel:
    ...
    class Testcloudstargy_addstatus(APITestBase):
        ...
        @allure.title("云策略-云策略列表-修改策略账号信息")
        def test_mascontrol_cloudTrader2(self, var_manager, logged_session, encrypted_password):
