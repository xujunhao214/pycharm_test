# lingkuan_youhua8/commons/api_base.py
import allure
import logging
import time
...
class APITestBase:
    ...
    def wait_for_database_record(self, db_transaction, sql, params, timeout=30, poll_interval=2):
        """智能等待数据库记录出现"""
        from lingkuan_youhua8.commons.wait_utils import wait_for_condition

        def check_db():
            return self.query_database(db_transaction, sql, params)
