# lingkuan_refine_model/commons/redis_utils.py
import redis
import json
from typing import Dict, Any, List
from lingkuan_refine_model.config import ENV_CONFIG  # 导入配置数据
from lingkuan_refine_model.commons.enums import Environment  # 导入现有枚举
