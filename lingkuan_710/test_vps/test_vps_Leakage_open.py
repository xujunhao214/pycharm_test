# lingkuan_710/tests/test_vps_ordersend.py
import allure
import logging
import pytest
import time
...
class TestLeakageopen(APITestBase):
    ...
    def test_update_slave(self, var_manager, logged_session, db_transaction):
        # 1. 发送修改策略账号请求
    ...
    def test_update_slave2(self, var_manager, logged_session, db_transaction):
        # 1. 发送修改策略账号请求
        add_Slave = var_manager.get_variable("add_Slave")
        user_accounts_1 = var_manager.get_variable("user_accounts_1")
        password = var_manager.get_variable("password")
