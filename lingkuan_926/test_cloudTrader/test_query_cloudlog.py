...
class TestCreate_cloudTrader(APITestBase):
    ...
    def test_query_logtype(self, logged_session, var_manager, status, status_desc):
    ...
    @allure.title("日志筛选：{status_desc}")
    def test_query_source(self, logged_session, var_manager, status, status_desc):
        with allure.step(f"1. 发送请求：查询{status_desc}"):
            data = {
                "page": 1,
                "limit": 200,
    ...
    def test_query_vps(self, logged_session, var_manager):
