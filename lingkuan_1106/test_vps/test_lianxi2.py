...
class TestVPSOrdersendsell:
    ...
    class TestVPSOrderSend1(APITestBase):
        ...
        @pytest.mark.dependency(name="test_trader_orderSend", depends=["test_follow_updateSlave"])
        @pytest.mark.url("vps")
        ...
        @pytest.mark.dependency(name="test_dbquery_orderSend", depends=["test_trader_orderSend"])
        ...
        @pytest.mark.dependency(name="test_dbquery_addsalve_orderSend", depends=["test_dbquery_orderSend"])
        ...
        @pytest.mark.dependency(name="test_trader_orderclose", depends=["test_dbquery_addsalve_orderSend"])
        @pytest.mark.url("vps")
        ...
        @pytest.mark.dependency(name="test_addtrader_orderclose", depends=["test_trader_orderclose"])
        ...
        @pytest.mark.dependency(name="test_dbquery_orderSendclose", depends=["test_addtrader_orderclose"])
        ...
        @pytest.mark.dependency(name="test_dbquery_addsalve_orderSendclose", depends=["test_dbquery_orderSendclose"])
