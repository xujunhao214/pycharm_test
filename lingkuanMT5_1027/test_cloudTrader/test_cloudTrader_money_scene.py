...
class TestMT5cloudTrader_moneyandscene:
    ...
    class TestMT5cloudTrader_money(APITestBase):
        ...
        def test_update_user(self, class_random_str, logged_session, var_manager, encrypted_password):
            ...
            MT5cloudTrader_MT5vps_id = var_manager.get_variable("MT5cloudTrader_MT5vps_ids_2")
                ...
                "vpsDescs": [
                    {
                        ...
                        "sourceId": MT5cloudTrader_MT5vps_id,
                        "sourceAccount": MT5cloudTrader_user_accounts_1,
                        "sourceName": "",
        ...
        def test_dbtrader_cfda(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                MT5cloudTrader_user_accounts_8 = var_manager.get_variable("MT5cloudTrader_user_accounts_8")
                sql = f"""
                        SELECT 
                            fod.size,
                            fod.comment,
                ...
                params = (
                    '0',
                    MT5cloudTrader_user_accounts_8,
                    class_random_str
                )
        ...
        def test_dbtrader_cfdp(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                MT5cloudTrader_user_accounts_9 = var_manager.get_variable("MT5cloudTrader_user_accounts_9")
                sql = f"""
                        SELECT 
                            fod.size,
                            fod.comment,
                ...
                params = (
                    '0',
                    MT5cloudTrader_user_accounts_9,
                    class_random_str
                )
        ...
        def test_dbtrader_cfdmin(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                MT5cloudTrader_user_accounts_10 = var_manager.get_variable("MT5cloudTrader_user_accounts_10")
                sql = f"""
                        SELECT 
                            fod.size,
                            fod.comment,
                ...
                params = (
                    '0',
                    MT5cloudTrader_user_accounts_10,
                    class_random_str
                )
    ...
    class TestMT5cloudTrader_Scence(APITestBase):
        ...
        def test_dbdetail_followParam5(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                MT5cloudTrader_user_accounts_5 = var_manager.get_variable("MT5cloudTrader_user_accounts_5")
                sql = f"""
                        SELECT 
                            fod.size,
                            fod.comment,
                ...
                params = (
                    '0',
                    MT5cloudTrader_user_accounts_5,
                    class_random_str
                )
        ...
        def test_dbdetail_templateId3(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                MT5cloudTrader_user_accounts_6 = var_manager.get_variable("MT5cloudTrader_user_accounts_6")
                ...
                params = (
                    '0',
                    MT5cloudTrader_user_accounts_6,
                    class_random_str
                )
        ...
        def test_dbaddsalve_euqit(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取跟单账号净值"):
                MT5cloudTrader_MT5vps_ids_6 = var_manager.get_variable("MT5cloudTrader_MT5vps_ids_6")

                sql = f"""
                        SELECT * FROM follow_trader WHERE id = %s
                        """
                params = (
                    MT5cloudTrader_MT5vps_ids_6
                )
            ...
            with allure.step("2. 提取数据"):
                ...
                logging.info(f"跟单账号净值：{MT5cloudTrader_add_euqit}")

        # @pytest.mark.skip(reason=SKIP_REASON)
        @allure.title("数据库校验-云跟单账号策略开仓-修改净值")
        def test_dbtrader_euqit2(self, class_random_str, var_manager, db_transaction):
            with allure.step("1. 获取订单详情表账号数据"):
                MT5cloudTrader_user_accounts_7 = var_manager.get_variable("MT5cloudTrader_user_accounts_7")
                ...
                params = (
                    '0',
                    MT5cloudTrader_user_accounts_7,
                    class_random_str
                )
            ...
            with allure.step("2. 校验数据"):
                ...
                true_size = MT5cloudTrader_add_euqit / cloud_euqit * 1
