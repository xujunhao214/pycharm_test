# lingkuanMT5_1112/commons/redis_utils.py
import redis
import json
from typing import Dict, Any, List
from lingkuanMT5_1112.config import ENV_CONFIG  # 导入配置数据
from lingkuanMT5_1112.commons.enums import Environment  # 导入现有枚举
