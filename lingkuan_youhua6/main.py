...
def run_tests(env: str = "test"):
    ...
    args = [
        ...
        # "tests/test_vps_ordersend.py",  # 测试用例目录
        # "tests/test_vps_close.py",  # 测试用例目录
        # "tests/test_vps_loukai.py",  # 测试用例目录
        # "tests/test_vps_louping.py",  # 测试用例目录
        "tests/test_create.py",  # 测试用例目录
        # "tests/test_delete.py",  # 测试用例目录
        # "tests/test_masOrderSend.py",  # 测试用例目录
        # "tests/test_masOrderSend_copy.py",  # 测试用例目录
