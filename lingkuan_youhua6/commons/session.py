...
from lingkuan_youhua6.commons.jsonpath_utils import JsonPathUtils
from lingkuan_youhua6.commons.enums import Environment
from lingkuan_youhua6.conftest import *
...
class EnvironmentSession(requests.Session):
    ...
    def request(self, method: str, url: str, *args, **kwargs) -> requests.Response:
        ...
        :return: 响应对象
        """
        # 自动判断使用base_url还是vps_url
        if url.startswith("/"):  # 相对路径，使用当前URL配置
            full_url = f"{self.current_url}{url}"
        else:  # 绝对URL，直接使用
            full_url = url
