...
from lingkuan_630.commons.session import EnvironmentSession, Environment
from lingkuan_630.commons.variable_manager import VariableManager
from lingkuan_630.commons.test_tracker import TestResultTracker  # 新增：测试结果追踪器
from lingkuan_630.commons.feishu_notification import send_feishu_notification  # 新增：飞书通知
from pathlib import Path
from lingkuan_630.commons.test_tracker import TestResultTracker
import sys
import os
...
ENV_CONFIG = {
    Environment.TEST: {
        ...
        "data_source_dir": "lingkuan_630/VAR"
    },
    Environment.PROD: {
        "base_url": "http://39.99.136.49:9000",
        "vps_url": "http://39.99.136.49:9001",
...
# # ------------------------------
# # 获取用户ID列表的fixture（在测试执行阶段获取数据）
# # ------------------------------
# @pytest.fixture
# def user_ids(request):
#     """使用request fixture动态获取用户ID列表"""
#     var_manager = request.getfixturevalue("var_manager")
#     return var_manager.get_variable_list("user_ids", [])
