...
from lingkuanMT5_1028.commons.redis_utils import *
...
class TestMT5cloudTrader_openandlevel:
    ...
    class TestMT5cloudTrader_open(APITestBase):
        ...
        def test_dbquery_redis(self, var_manager, db_transaction, redis_MT5cloudTrader_data_send):
    ...
    class TestMT5cloudTrader_level(APITestBase):
        ...
        def test_dbquery_redis(self, var_manager, db_transaction, redis_MT5cloudTrader_data_close):
            with allure.step("1. 获取订单详情表账号数据"):
                MT5cloudTrader_user_accounts_2 = var_manager.get_variable("MT5cloudTrader_user_accounts_2")
                cloudOrderSend = var_manager.get_variable("cloudOrderSend")
                symbol = cloudOrderSend["symbol"]
    ...
    class Testcloudstargy_addstatus(APITestBase):
        ...
        @allure.title("云策略-云策略列表-修改策略账号信息")
        def test_mascontrol_MT5cloudTrader2(self, var_manager, logged_session, encrypted_password):
